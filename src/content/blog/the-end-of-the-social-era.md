---
title: 写于社交平台终结之时
pubDate: 2023-07-12 10:04:47
description: 没有什么东西能永远保持热度，但当曾经熟悉的事物变得四分五裂，才惊觉世界已经发生了如此多的转变
category: 杂谈
slug: the-end-of-the-social-era
---
...
![mastodon-don-screenshot](./the-end-of-the-social-era/mastodon-don.png)
...
在 Fediverse 之外，还有一种正在发展的社群去中心化协议名为 [AT Protocol](https://atproto.com)。和 Fediverse 不同，AT Protocol 最初在 Twitter 内部诞生，作为 Twitter 未来发展的前瞻性研究。并在后期逐渐脱离 Twitter 独立开发。而基于 AT Protocol 的"样板房"就是 [Bluesky](https://blueskyweb.xyz)。
...
从目前来看 Bluesky 最贴合我的理想社群环境，但其也有短期内无法解决的硬伤，也是社群发展最重要的指标——用户数。社群的粘性是由用户和内容共同决定的，而非其理念先进与否。无人使用的社群平台也就失去了社群使用的最大意义。读完 Bluesky 的 [FAQ](https://blueskyweb.xyz/faq) 以后，我发现 Bluesky 似乎有意促成这点。Bluesky 非常推崇邀请机制，并认为其为社群发展带来诸多好处，还将在后续开发过程中引导新实例的管理员使用邀请机制。若是如此，我认为 Bluesky 的前景也并不明朗。它或许能建立去中心化的理想国，却难以容纳社群中的多数用户，注定小众。
